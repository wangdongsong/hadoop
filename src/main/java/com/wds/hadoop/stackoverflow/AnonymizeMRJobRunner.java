...
public class AnonymizeMRJobRunner extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(AnonymizeMRJobRunner.class);
    ...
    private class AnonymizeReducer extends Reducer<IntWritable, Text, Text, NullWritable> {
    ...
    private class AnonymizeMapper extends Mapper<Object, Text, IntWritable, Text> {
