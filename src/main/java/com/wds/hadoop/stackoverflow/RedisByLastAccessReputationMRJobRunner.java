...
public class RedisByLastAccessReputationMRJobRunner extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(RedisByLastAccessReputationMRJobRunner.class);
        ...
        job.setOutputKeyClass(RedisByLastAccessDataPrititionMRJobRunner.RedisKey.class);
    ...
    public static class RedisLastAccessInputFormat extends
            InputFormat<RedisByLastAccessDataPrititionMRJobRunner.RedisKey, Text> {
        ...
        @Override
        public RecordReader<RedisByLastAccessDataPrititionMRJobRunner.RedisKey, Text> createRecordReader(
        ...
        public static class RedisLastAccessRecordReader extends
                RecordReader<RedisByLastAccessDataPrititionMRJobRunner.RedisKey, Text> {
            ...
            private RedisByLastAccessDataPrititionMRJobRunner.RedisKey key = new RedisByLastAccessDataPrititionMRJobRunner.RedisKey();
            ...
            public boolean nextKeyValue() throws IOException,
                ...
                do {
                    ...
                    if (hashIterator.hasNext()) {
                        ...
                        key.setField(new Text(currentEntry.getKey()));
            ...
            @Override
            public RedisByLastAccessDataPrititionMRJobRunner.RedisKey getCurrentKey() throws IOException,
                    InterruptedException {
                return key;
            }
